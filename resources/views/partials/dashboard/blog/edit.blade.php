<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
    ...
    <div class="col-lg-8">
        <form method="POST" action="/dashboard/blog/{{ $blogEdit->slug }}" enctype="multipart/form-data">
            @method('put')
            @csrf
            ...
            <div class="mb-3">
                ...
                <input type="nameBlog" class="form-control  @error('nameBlog') is-invalid @enderror"
                    value="{{ old('nameBlog', $blogEdit->nameBlog) }}" id="nameBlog" aria-describedby="emailHelp"
                    name="nameBlog">
                @error('nameBlog')
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control @error('slug') is-invalid @enderror" id="slug"
                    aria-describedby="emailHelp" name="slug" value="{{ old('slug', $blogEdit->slug) }}">
                @error('slug')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
            ...
            <div class="mb-3">
                ...
                @if ($blogEdit->imageBlog)
                    <img src="{{ asset('storage/' . $blogEdit->imageBlog) }}"
            ...
            <div class="mb-3">
                ...
                <input type="number" class="form-control  @error('comment') is-invalid @enderror"
                    value="{{ old('comment', $blogEdit->comment) }}" id="comment" aria-describedby="emailHelp"
                    name="comment">
                @error('comment')
                    <div class="invalid-feedback">
                        {{ $message }}
            ...
            <div class="mb-3">
                ...
                <input id="deskripsi" type="hidden" name="deskripsi"
                    value="{{ old('deskripsi', $blogEdit->deskripsi) }}">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control  @error('date') is-invalid @enderror"
                    value="{{ old('date', $blogEdit->date) }}" id="date" aria-describedby="emailHelp"
                    name="date">
                @error('date')
                    <div class="invalid-feedback">
                        {{ $message }}
