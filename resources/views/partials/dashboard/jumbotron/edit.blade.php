<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
    ...
    <div class="col-lg-8">
        <form method="POST" action="/dashboard/jumbotron/{{ $jumbotronEdit->slug }}" enctype="multipart/form-data">
            @method('put')
            @csrf

            <div class="mb-3">

                <label for="judulJumbotron" class="form-label">Name jumbotron</label>

                <input type="judulJumbotron" class="form-control  @error('judulJumbotron') is-invalid @enderror"
                    value="{{ old('judulJumbotron', $jumbotronEdit->judulJumbotron) }}" id="judulJumbotron"
                    aria-describedby="emailHelp" name="judulJumbotron">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control @error('slug') is-invalid @enderror" id="slug"
                    aria-describedby="emailHelp" name="slug" value="{{ old('slug', $jumbotronEdit->slug) }}">
                @error('slug')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
            ...
            <div class="mb-3">
                ...
                @if ($jumbotronEdit->imageJumbotron)
                    <img src="{{ asset('storage/' . $jumbotronEdit->imageJumbotron) }}"
            ...
            <div class="mb-3">
                ...
                <input type="judulUtama" class="form-control  @error('judulUtama') is-invalid @enderror"
                    value="{{ old('judulUtama', $jumbotronEdit->judulUtama) }}" id="judulUtama"
                    aria-describedby="emailHelp" name="judulUtama">
                @error('judulUtama')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
            ...
            <div class="mb-3">
                ...
                <input type="organic" class="form-control  @error('organic') is-invalid @enderror"
                    value="{{ old('organic', $jumbotronEdit->organic) }}" id="organic" aria-describedby="emailHelp"
                    name="organic">
                @error('organic')
                    <div class="invalid-feedback">
                        {{ $message }}
            ...
            <div class="mb-3">
                ...
                <input id="deskripsi" type="hidden" name="deskripsi"
                    value="{{ old('deskripsi', $jumbotronEdit->deskripsi) }}"">
            ...
            <div class="mb-3">
                ...
                <input type="action" class="form-control  @error('action') is-invalid @enderror"
                    value="{{ old('action', $jumbotronEdit->action) }}" id="action" aria-describedby="emailHelp"
                    name="action">
                @error('action')
                    <div class="invalid-feedback">
                        {{ $message }}
