<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
    ...
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">Create New Banner</h1>
    </div>
        ...
        <form method="POST" action="/dashboard/banner" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control  @error('title') is-invalid @enderror"
                    value="{{ old('title') }}" id="title" aria-describedby="emailHelp" name="title">
                @error('title')
            ...
            {{-- <div class="mb-3">
                ...
                <input type="text" class="form-control  @error('bannerNews') is-invalid @enderror"
                    value="{{ old('bannerNews') }}" id="bannerNews" aria-describedby="emailHelp" name="bannerNews">
                @error('bannerNews')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
